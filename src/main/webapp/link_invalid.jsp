...
<head>
    ...
    <link rel="stylesheet" href="styles/link_invalid.css">
</head>
<body>

    <div class="standup_animation" style="  margin: 0 auto; text-align: center;  width: 50%;">
        <h1 style="margin-top: 5px;font-weight: bold;">The link you followed has expired or invalid, you can request
            another one in this link</h1>
