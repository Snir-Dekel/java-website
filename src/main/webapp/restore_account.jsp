...
<head>
    ...
    <link rel="stylesheet" href="styles/restore_acount.css">
</head>
...
">
    ...
    <div class="center">
        <h1 class="text-primary" id="restore_account_h1">Restore account</h1>
        <form style="width: 50%;" class="needs-validation container bg-dark mt-2 border_rotate" novalidate
            ...
            <div id="main" style="display: table;margin: 0 auto;padding-top:1rem;user-select: none">
                ...
                <button class="btn btn-primary btn-lg btn-rounded button" id="restore_account_button" type="submit"
                        onclick="send_restore_email()" style="
    width: 13rem;
    margin-top: 2rem;
    height: 4.4rem;
    ...
    padding-right: 0.5rem;
            "
                ><span id="restore_account_text_span">Send email</span><span id="loading_span"
    ...
    <script>
      ...
      function handle_email_validity() {
        ...
        let button = document.getElementById("restore_account_button")
      ...
      async function send_restore_email() {
        let button = document.getElementById("restore_account_button")
        ...
        document.getElementById("restore_account_text_span").style.display = "none"
        ...
        $.ajax({
          type: "post",
          url: "https://${pageContext.request.serverName}/email-restore-account?email=" +
        ...
        span_loading.classList.toggle("spinner-border")
        document.getElementById("restore_account_text_span").style.display = "inline"
        grecaptcha.reset();
